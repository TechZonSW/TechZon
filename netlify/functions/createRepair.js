  ...
  const newRepairData = {
    ...
    try {
      ...
      if (customerPhone) { // Skicka bara om ett telefonnummer finns
          const welcomeMessage = `Hej ${customerName}! Ditt serviceärende hos TechZon är nu registrerat för din ${deviceName}. Din unika spårningskod är ${newRepairCode}. Följ reparationen live här: https://techzon.netlify.app/spara`;
